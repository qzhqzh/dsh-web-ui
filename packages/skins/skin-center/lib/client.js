	...
	factory: (require) => {
		...
		const SKIN_CENTER_ENTRIES = [
			...
			},
			{
				...
				"description": "《夜航舱》V5：桌面宽屏背景保持同一张夜航舱构图，以 EDSR ×4 超分辨率重建为 3456×2160 高质量 WebP 内嵌交付，不再由浏览器拉伸旧的 864×540 图片；摄影层无全局模糊和整屏雾化蒙版。亮色侧边栏采用清透蓝白半透明层级，暗色采用克制深蓝层级，composer 外层继续保持透明。",
				"tags": [
					"future-life",
					"maglev",
					"night",
