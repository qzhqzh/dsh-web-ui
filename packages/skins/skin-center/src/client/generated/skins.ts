...
export const SKIN_CENTER_ENTRIES: readonly SkinCenterEntry[] = [
  ...
  {"id":"neon-sleeper","name":"夜航舱","nameEn":"Neon Sleeper","author":"qzhqzh","tagline":"高清未来夜行卧铺 · 清透蓝白界面 · 安静陪伴","description":"《夜航舱》V5：桌面宽屏背景重新从原始卧铺舱图片制作，以 3172×1984 高质量 WebP 内嵌交付，不再从低分辨率中间图放大；摄影层无全局模糊和整屏雾化蒙版。亮色侧边栏采用清透蓝白半透明层级，暗色采用克制深蓝层级，composer 外层继续保持透明。","tags":["future-life","maglev","night","photography","hd","minimal"],"accent":"#63b8e6","bodyAttr":"data-dsh-neon-sleeper","package":"@linxin666/dsh-client-ui-skin-neon-sleeper","order":11},
